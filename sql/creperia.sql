...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2022 a las 20:17:52
...
(14, 'San Mateo 19', 'Solidaridad', 'Tuititlan', '5532614596', 540.00, 'confirm', '2022-05-15', '20:33:22', 6);
...
(1, 'Emmanuel ', 'Hernandez', 'emmanuel@mail.com', '$2y$04$zhgKoqSokKPR3diz9cQ.ROBoFv2MmzwSEwaFWCwDerpcOBHOAQeXW', 'admin', NULL),
...
ALTER TABLE `facturas`
  ...
  ADD CONSTRAINT `fk_facturas_producto` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`);
